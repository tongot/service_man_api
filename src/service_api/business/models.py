...
class Business(models.Model):
    ...
    owner = models.ForeignKey(
        'account_api.UserAccount', on_delete=models.CASCADE)
    address = models.CharField(max_length=255, blank=False)
    location = models.ForeignKey(Location, on_delete=models.CASCADE, null=True)
    phone = models.CharField(max_length=15, blank=False)
    business_logo = models.ImageField(
        'business logo', blank=True, null=True, upload_to=image_name_id)
...
class BusinessContactPerson(models.Model):
    ...
    business = models.ForeignKey(
        Business, related_name='contact_person', on_delete=models.CASCADE)
...
class BusinessDirectors(models.Model):
    ...
    business = models.ForeignKey(
        Business, related_name='directors', on_delete=models.CASCADE)
...
class BusinessProfile(models.Model):
    ...
    paypal_mechant_id = models.CharField(max_length=225, blank=True, null=True)
    delivery_outside_country = models.BooleanField(default=False)
...
class BusinessReviews(models.Model):
    ...
    stars = models.IntegerField(
        choices=STARS, default=0, blank=True, null=True)
    user = models.ForeignKey('account_api.UserAccount',
...
class BusinessCommentReply(models.Model):
    """Business comment replies are stored here"""
    comment = models.CharField(max_length=5000, blank=False)
    business_comment = models.ForeignKey(
        BusinessComment, on_delete=models.CASCADE)
    user = models.ForeignKey('account_api.UserAccount',
                             on_delete=models.CASCADE)
    business = models.ForeignKey(
...
class ProductImages(models.Model):
    image = models.ImageField(
        'product image', blank=True, null=True,  upload_to=image_name_id)
...
class OtherProductProperty(models.Model):
    ...
    product = models.ForeignKey(
        Product, related_name='other_properties', on_delete=models.CASCADE)
